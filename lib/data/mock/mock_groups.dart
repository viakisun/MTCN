...
class MockGroups {
  static final List<Group> all = [
    Group(
      ...
      members: [], // TODO: MockPlayers.findByIds(['1', '2', '3', '5']),
    ...
    Group(
      ...
      isPremium: true,
      status: GroupStatus.active,
      members: [], // TODO: MockPlayers.findByIds(['1', '4', '5', '6']),
    ...
    Group(
      ...
      isPremium: false,
      status: GroupStatus.active,
      members: [], // TODO: MockPlayers.findByIds(['2', '3', '7']),
    ...
    Group(
      ...
      status: GroupStatus.active,
      members:
          [], // TODO: MockPlayers.findByIds(['1', '2', '3', '4', '5', '6', '7', '8']),
    ...
    Group(
      ...
      isPremium: false,
      status: GroupStatus.active,
      members: [], // TODO: MockPlayers.findByIds(['2', '5', '8']),
    ...
    Group(
      ...
      isPremium: true,
      status: GroupStatus.active,
      members: [], // TODO: MockPlayers.findByIds(['3', '6']),
    ...
    Group(
      ...
      isPremium: false,
      status: GroupStatus.active,
      members: [], // TODO: MockPlayers.findByIds(['4', '7', '8']),
